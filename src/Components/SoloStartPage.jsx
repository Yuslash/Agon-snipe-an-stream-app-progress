...
export default function SoloStartPage({ playAudio, videoRef, stopAudio }) {
    ...
    return <>
        ...
        <div className="gradient-over flex absolute top-0 left-0 w-full h-full ">
            <div className="top-nav z-20 absolute top-0 left-0 w-full bg-blue-400 ">
                <img className="flex-shrink-0 w-[200px] h-auto" src="solologo.png" />
                ...
                <div className="flex items-center gap-2">
                    <img onClick={toSignup} onMouseEnter={playAudio} className="solohover" src="/Buttons/solobefore.png" />
                    <img onClick={toLogin} onMouseEnter={playAudio} className="solologin" src="/Buttons/logins/solobefore.png" />
                </div>
            </div>
            ...
            <div className="left-row w-full h-full justify-center flex flex-col ">
                ...
                <div className="flex flex-col mt-20 gap-5 px-[180px] ">
                    ...
                    <span className="the-hunt floating">Solo Level <br /> Jung Su</span>
                    ...
                    <div className=" flex px-20 mt-6 w-full">
                        <img onMouseEnter={playAudio} className="fortnite-button" src="/Buttons/fortbutton.png"></img>
                    </div>
